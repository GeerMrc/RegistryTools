...
# ============================================================
# MCP 工具接口实现 (TASK-500 to TASK-504)
# ============================================================
...
def create_server(data_path: Path) -> FastMCP:
    ...
    # ========================================================
    # MCP 工具: get_tool_definition (TASK-502)
    # ========================================================
    ...
    # ========================================================
    # MCP 工具: list_tools_by_category (TASK-503)
    # ========================================================

...
### 修复
- **文档版本号统一** (2026-01-11)
  - 修正所有文档中的版本号不一致问题（12个文件更新至 v0.2.1）
  - 修复 CONFIGURATION.md 内部版本号不一致
  - 更新文档索引表中的版本信息
- **PyPI 发布状态文档** (2026-01-11)
  - 统一所有文档中的 PyPI 发布状态描述
  - 移除"尚未发布到 PyPI"的过时警告（9个文档）
  - 更新 README.md 安装说明，突出 PyPI 安装方式
- **代码质量** (2026-01-11)
  - 修复 MyPy 类型检查错误（11个）
  - 修复 Ruff 代码质量警告（7个）
  - 修复导入顺序问题（sqlite_storage.py）

### 文档
- 更新 README.md 添加 Embedding 搜索配置说明
  - 添加 REGISTRYTOOLS_SEARCH_METHOD 和 REGISTRYTOOLS_DEVICE 环境变量说明
  - 添加性能对比表格和 GPU 内存需求说明
  - 添加 Embedding 依赖安装命令
- 更新 CLAUDE_CONFIG.md 添加 Embedding 环境变量说明
- 更新 IDE_CONFIG.md 添加 Embedding 环境变量说明
- 确认所有文档版本号一致为 v0.2.1

### 变更
- **版本号更新**: 0.2.0 → 0.2.1
- **向后兼容**: 完全兼容，仅文档更新和代码质量改进
